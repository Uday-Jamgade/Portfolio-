...
const ShowCase = () => {
  ...
  const buttonBase =
    'font-bold text-lg sm:text-xl border-2 border-white hover:bg-white hover:text-black text-white px-6 py-2 transition-all duration-300 rounded-3xl whitespace-nowrap'
  ...
  return (
    <motion.div
      ...
      id='Portfolio'
      className="px-4 py-12 -mb-10"
    >
      <motion.h1
        initial={{ opacity: 0, scale: 0.9 }}
        animate={isInView ? { opacity: 1, scale: 1 } : {}}
        transition={{ delay: 0.2, duration: 0.5 }}
        className="text-6xl font-extrabold text-center text-fuchsia-600"
      >
        Portfolio Showcase
      </motion.h1>
      ...
      <motion.p
        ...
        className="capitalize text-xl text-center mt-5 text-zinc-400"
      >
    ...
    <motion.div
      ...
      className="flex flex-row justify-center items-center sm:text- gap-4 mt-10 px-4"
    >
